...
import 'package:modul_cam_qr_1285/utils/logging_utils.dart';
import 'package:modul_cam_qr_1285/views/camera/display_picture.dart';
...
class _CameraViewState extends State<CameraView> {
  ...
  Future<void> initializeCamera() async {
    ...
    if (mounted) {
      setState(() {});
      LoggingUtils.logEndFunction("success intialize camera".toUpperCase());
    }
  }
